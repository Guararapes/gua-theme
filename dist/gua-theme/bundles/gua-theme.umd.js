(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('gua-theme', ['exports', 'rxjs/operators', '@angular/platform-browser/animations', '@angular/common', '@angular/router', '@angular/cdk/drag-drop', '@angular/cdk/scrolling', '@angular/cdk/table', '@angular/cdk/tree', '@angular/material', 'ng-material-multilevel-menu', '@angular/forms', '@angular/core'], factory) :
    (factory((global['gua-theme'] = {}),global.rxjs.operators,global.ng.platformBrowser.animations,global.ng.common,global.ng.router,global.ng.cdk['drag-drop'],global.ng.cdk.scrolling,global.ng.cdk.table,global.ng.cdk.tree,global.ng.material,global.ngMaterialMultilevelMenu,global.ng.forms,global.ng.core));
